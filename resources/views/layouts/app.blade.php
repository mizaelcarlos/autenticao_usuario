...
<head>
    ...
    <script src="/components/bootstrap/js/alebootstrap-datepicker.min.js"></script>
    ...
    <script src="/components/bootstrap/js/index.js"></script>
    ...
    <script src="/components/bootstrap/js/util.js"></script>
